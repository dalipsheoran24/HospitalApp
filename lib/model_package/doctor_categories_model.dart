...
const List<DoctorCategoriesModel> doctorCategoriesModel = const <DoctorCategoriesModel>[
  const DoctorCategoriesModel(
    categoriesName: 'Dentist',icon: Icons.remove_red_eye_outlined,openPageName: Routes.DENTIST,
    colorModel:  Color.fromRGBO(238,248,248,1),
  ),
const DoctorCategoriesModel(
    categoriesName: 'Orthopedic',icon: Icons.remove_red_eye_outlined,openPageName: Routes.ORTHOPENDIC,
...
const DoctorCategoriesModel(
    categoriesName: 'Cardiologists',icon: Icons.remove_red_eye_outlined,openPageName: Routes.CARDIOLOGISTS,
    colorModel:  Color.fromRGBO(239,227,248,1),
  ),
const DoctorCategoriesModel(
    categoriesName: 'Ophthalmologist',icon: Icons.remove_red_eye_outlined,openPageName: Routes.OPHTHALMOLOGIST,
    colorModel:  Color.fromRGBO(255,241,232,1),
  ),
const DoctorCategoriesModel(
    categoriesName: 'Detmatologist',icon: Icons.remove_red_eye_outlined,openPageName: Routes.DETMATOLOGIST,
